https://docs.gbif.org/doc-sensitive-species-data-generalization/[image:https://docs.gbif.org/doc-sensitive-species-data-generalization/gbif-document-shield.svg[GBIF Document]]
