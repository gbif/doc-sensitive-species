...
In this report we assessed these different frameworks against https://doi.org/10.15468/doc-5jp4-5g10[Chapman (2020^)]´s framework to see to what extent these elements are addressed across different organizations´ frameworks (<<appa,Appendix 1>>). The two major elements of this framework are below, with sub-components of the framework in bold italics:
